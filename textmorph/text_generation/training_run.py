        ...
        def examples_from_file(path):
            ...
            with codecs.open(path, 'r', encoding='utf-8') as f:
                for line in verboserate(f, desc='Reading data file.', total=total_lines):
                    ...
                    examples.append(EditExample(source_words=src_words, insert_words=[], insert_exact_words=[u'war'], delete_words=[], delete_exact_words=[u'bin'], target_words=[], edit_embed=None))
            return examples
